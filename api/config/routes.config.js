...
router.post('/register', secure.isNotAuthenticated, upload.single('avatar'), user.create)
router.post('/login', secure.isNotAuthenticated, user.login)
router.post('/logout', secure.isAuthenticated, user.logout)
router.get('/user/me', secure.isAuthenticated, user.detail)
...
router.get('/travels', travel.listAll)
